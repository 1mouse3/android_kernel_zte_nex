...
#if defined(CONFIG_MACH_AURORA)||defined(CONFIG_MACH_GORDON)||defined(CONFIG_MACH_HAYES) || defined(CONFIG_MACH_ILIAMNA)
...
struct i2c_registry msm8960_isp_camera_i2c_devices = {
	...
	if (machine_is_msm8960_cdp())
        ...
        mach_mask = I2C_FFA;
#elif defined(CONFIG_MACH_AURORA)
	else if (machine_is_aurora())
		mach_mask = I2C_FFA;
#elif defined(CONFIG_MACH_FROSTY)
...
MACHINE_START(AURORA, "ZTE MSM8960 AURORA")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
